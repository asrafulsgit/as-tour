...
const getBookingStatsController = asyncHandler(
...
const getPaymentStatsController = asyncHandler(
  async (req: Request, res: Response) => {
...
const getUserStatsController = asyncHandler(
  async (req: Request, res: Response) => {
...
const getTourStatsController = asyncHandler(
  async (req: Request, res: Response) => {
